...
public class BeautyFilterLow extends BaseFilter {
    ...
    public BeautyFilterLow() {
        this(FilterType.IMAGE);
    }

    public BeautyFilterLow(FilterType filterType) {
        super(0, R.raw.beauty_fragment_low_optimization);
        setFilterType(filterType);
        setBeautyLevel(5);
    }

    public BeautyFilterLow setBeautyLevel(int level) {
        switch (level) {
            case 1:
